...
API_TOKEN	Your AQICN API key used for fetching live air quality data. Obtain from https://aqicn.org/data-platform/token/￼.	your-aqicn-api-token
...
MONGO_DB	Both	Specifies which MongoDB database to read/write from.
MONGO_COLLECTION	Both	Defines which MongoDB collection (e.g., city_data) stores your air-quality records.
...
Your .github/workflows/fetch.yml (GitHub Action) automatically injects these:
...
This ensures the job runs securely without hardcoding credentials in your repo.
